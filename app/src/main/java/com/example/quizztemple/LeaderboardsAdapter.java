...
import com.example.quizztemple.databinding.RowLeaderboardsBinding;
...
public class LeaderboardsAdapter extends RecyclerView.Adapter<LeaderboardsAdapter.LeaderboardViewHolder> {
    ...
    Context context;
    ArrayList<com.example.quizztemple.User> users;

    public LeaderboardsAdapter(Context context, ArrayList<com.example.quizztemple.User> users) {
    ...
    public void onBindViewHolder(@NonNull LeaderboardViewHolder holder, int position) {
        com.example.quizztemple.User user = users.get(position);
