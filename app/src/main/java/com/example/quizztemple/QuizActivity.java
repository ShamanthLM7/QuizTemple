...
import com.example.quizztemple.databinding.ActivityQuizBinding;
...
public class QuizActivity extends AppCompatActivity {
    ...
    ArrayList<com.example.quizztemple.Question> questions;
    int index = 0;
    com.example.quizztemple.Question question;
                    ...
                    database.collection("categories")
                        ...
                        public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                            for(DocumentSnapshot snapshot : queryDocumentSnapshots) {
                                com.example.quizztemple.Question question = snapshot.toObject(com.example.quizztemple.Question.class);
        ...
        switch (view.getId()){
            ...
            case R.id.nextBtn:
                ...
                if(index < questions.size()-1) {
                    ...
                    Intent intent = new Intent(QuizActivity.this, com.example.quizztemple.ResultActivity.class);
